...
using JebsBoxOfTears.UI;
using UitkForKsp2.API;
using UnityEngine;
using UnityEngine.UIElements;

namespace JebsBoxOfTears;

[BepInPlugin(MyPluginInfo.PLUGIN_GUID, MyPluginInfo.PLUGIN_NAME, MyPluginInfo.PLUGIN_VERSION)]
[BepInDependency(SpaceWarpPlugin.ModGuid, SpaceWarpPlugin.ModVer)]
public class JebsBoxOfTearsPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static JebsBoxOfTearsPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-JebsBoxOfTearsFlight";
    internal const string ToolbarOabButtonID = "BTN-JebsBoxOfTearsOAB";
    internal const string ToolbarKscButtonID = "BTN-JebsBoxOfTearsKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "JebsBoxOfTears_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "JebsBoxOfTears.Unity.dll"));
